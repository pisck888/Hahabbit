...
class CustomPresentationController: UIPresentationController {
    ...
    override var frameOfPresentedViewInContainerView:CGRect {
        ...
        frame.origin.y = containerView.bounds.size.height -
          CustomPresentationController.viewHeight -
          CustomPresentationController.buttonTopPadding -
          CustomPresentationController.viewLeftPadding -
          containerView.safeAreaInsets.bottom + 12
